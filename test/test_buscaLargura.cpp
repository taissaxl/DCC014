...
#include "lista.h"
#include "vertice.h"
#include "algoritmos/largura.h"  // Inclui a implementação do BFS
...
TEST_F(BuscaLarguraTest, TestBuscaLargura)
{
    Grafo* grafo = new Grafo();
    int auxId;

    // Cria 6 vértices (de 0 a 5)
    ...
    Lista<Vertice> caminhoCalculado = buscaLargura(grafo, CIDADE_A, CIDADE_D);

    // Define o caminho esperado: 0 -> 1 -> 3
    ...
    delete grafo; // Libera a memória alocada para o grafo
}
